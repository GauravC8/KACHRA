...
class MathDemo {
	 ...
	 * 
	 * @param s
	 *            String that will be printed to STDOUT.
	 */
	...
	/**
	 * Random Numbers. Java provides a Random method that returns a pseudo-random
...
class MathLibraryExample {
	...
	public static void main(final String[] args) {
		...
		MathDemo.prt();
		MathDemo.printMathConstants();
		MathDemo.doComparisonOperators();
		MathDemo.doTrigonometricMethods();
		MathDemo.doExponentialLogarithmicMethods();
		MathDemo.doPower();
		MathDemo.doSquareRoot();
		MathDemo.doRandomNumbers();
	}
