...
public class LocaleDemo {
	public static void main(String[] args) {
		...
		System.out.println("\nCountry Name : " + loc1.getDisplayCountry());

		// Use of getCountry() :
		System.out.println("Country Name ISO 3166 2-letter code : " + loc1.getCountry());

		// Use of equal() :
		System.out.println("\nIs loc1 equals loc2 : " + loc1.equals(loc2));

		// clone() : loc3 is a clone of loc2
		Locale loc3 = (Locale) loc2.clone();

		// Locale : loc3
		System.out.println("Locale loc3 same as loc2 : " + loc3);
		...
		System.out.println("\nloc2 Language : " + loc2.getDisplayLanguage());

		// Use of getDisplayLanguage(Locale in) :
		System.out.println("Language of in Locale : " + loc1.getDisplayLanguage(new Locale("France", "French")));

		// Use of getDisplayName :
		System.out.println("\nUse of getDisplayName : " + loc1.getDisplayName());

		// Use of getDisplayName(Locale in) :
		System.out.println("Name of in Locale : " + loc2.getDisplayName(new Locale("English", "english")));

		// Use of getISO3Country() :
		System.out.println("\nISO3 Country Name of loc3 : " + loc3.getISO3Country());
