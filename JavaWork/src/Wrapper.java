public class Wrapper {
	...
	public static void main(String[] args) {
		/*
		 * String number =args[0]; Byte byNum=Byte.valueOf(number); Short
		 * shNum=Short.valueOf(number); Integer num = Integer.valueOf(number); Long
		 * lgNum=Long.valueOf(number); System.out.println(byNum);
		 * System.out.println(shNum); System.out.println(num);
